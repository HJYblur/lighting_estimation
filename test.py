...
from data_loader import CustomData, data_transform, TRAIN_PATH, TEST_PATH, TEMP_LIST, DIR_LIST
...
def preprocess_img(img_name):
    image = Image.open(os.path.join(TRAIN_PATH, img_name)).convert("RGB")
...
t_model = load_model(16, 't')
d_model = load_model(16, 'd')
batch_test(200)
# sum_test() 
