...
VIDIT_train_dataset = torch.utils.data.DataLoader(
    VIDITDataset(data_dir=TRAIN_PATH), batch_size=batch_size, shuffle=True
)
VIDIT_valid_dataset = torch.utils.data.DataLoader(
    VIDITDataset(data_dir=VALID_PATH), batch_size=batch_size, shuffle=True
)
